...
#define LCD_DB5_PIN PORTS_BIT_POS_5
#define LCD_DB5_PIN_MASK (0x1 << 5)

/*** Functions for LCD_DB6 pin ***/
#define LCD_DB6_PORT PORT_CHANNEL_E
#define LCD_DB6_PIN PORTS_BIT_POS_6
#define LCD_DB6_PIN_MASK (0x1 << 6)

/*** Functions for LCD_DB7 pin ***/
#define LCD_DB7_PORT PORT_CHANNEL_E
#define LCD_DB7_PIN PORTS_BIT_POS_7
#define LCD_DB7_PIN_MASK (0x1 << 7)

/*** Functions for LCD_DB4 pin ***/
#define LCD_DB4_PORT PORT_CHANNEL_E
#define LCD_DB4_PIN PORTS_BIT_POS_4
#define LCD_DB4_PIN_MASK (0x1 << 4)
